...
const testimonials = [
  {
    ...
    role: 'Business Owner',
    rating: 5,
    text: 'Sanskruti Associates helped me get a Personal & Business Loan with the best interest rate. The process was smooth and the team was very professional.',
  },
  {
    name: 'Shekhar Shinde',
    role: 'Homebuyer',
