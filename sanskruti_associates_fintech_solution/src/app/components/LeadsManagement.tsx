...
const leadsData = [
  { id: 1, name: 'Shekhar Shinde', phone: '+91 7758969798', loanType: 'Home Loan', amount: '₹45,00,000', status: 'Approved', assignedTo: 'Shekhar Shinde', date: '15/04/2026' },
  { id: 2, name: 'Shekhar Shinde', phone: '+91 7758969798', loanType: 'Personal & Personal & Business Loan', amount: '₹5,00,000', status: 'Pending', assignedTo: 'Shekhar Shinde', date: '14/04/2026' },
  { id: 3, name: 'Shekhar Shinde', phone: '+91 7758969798', loanType: 'Car Loan', amount: '₹8,50,000', status: 'In Review', assignedTo: 'Shekhar Shinde', date: '13/04/2026' },
  { id: 4, name: 'Shekhar Shinde', phone: '+91 7758969798', loanType: 'Personal & Business Loan', amount: '₹25,00,000', status: 'Approved', assignedTo: 'Shekhar Shinde', date: '12/04/2026' },
  { id: 5, name: 'Shekhar Shinde', phone: '+91 7758969798', loanType: 'Home Loan', amount: '₹60,00,000', status: 'Rejected', assignedTo: 'Shekhar Shinde', date: '11/04/2026' },
  { id: 6, name: 'Shekhar Shinde', phone: '+91 7758969798', loanType: 'Personal & Personal & Business Loan', amount: '₹3,00,000', status: 'Pending', assignedTo: 'Shekhar Shinde', date: '10/04/2026' },
  { id: 7, name: 'Shekhar Shinde', phone: '+91 7758969798', loanType: 'Machinery Loan', amount: '₹12,00,000', status: 'In Review', assignedTo: 'Shekhar Shinde', date: '09/04/2026' },
  { id: 8, name: 'Shekhar Shinde', phone: '+91 7758969798', loanType: 'Home Loan', amount: '₹55,00,000', status: 'Approved', assignedTo: 'Shekhar Shinde', date: '08/04/2026' },
  { id: 9, name: 'Shekhar Shinde', phone: '+91 7758969798', loanType: 'Car Loan', amount: '₹6,50,000', status: 'Pending', assignedTo: 'Shekhar Shinde', date: '07/04/2026' },
  { id: 10, name: 'Shekhar Shinde', phone: '+91 7758969798', loanType: 'Personal & Business Loan', amount: '₹18,00,000', status: 'Approved', assignedTo: 'Shekhar Shinde', date: '06/04/2026' },
];
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg mb-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <select className="h-12 px-4 rounded-lg border border-gray-300 focus:border-[#2563EB] focus:outline-none">
              ...
              <option>Personal & Personal & Business Loan</option>
              <option>Car Loan</option>
              <option>Personal & Business Loan</option>
