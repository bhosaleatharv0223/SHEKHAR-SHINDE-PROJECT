...
const propertyDocuments = [
  { key: 'NA Order Copy', label: 'NA Order Copy', required: true },
  { key: 'Copy of Sale Deed', label: 'Copy of Sale Deed', required: true },
  { key: '7/12 Extract', label: '7/12 Extract', required: true },
  { key: 'Index II Extract', label: 'Index II Extract', required: true },
  { key: 'Latest Tax Paid Receipt', label: 'Latest Tax Paid Receipt', required: true },
  { key: 'Mutation Entry / Ferfar', label: 'Mutation Entry / Ferfar', required: true },
  { key: 'Sanctioned Plan for Buildings', label: 'Sanctioned Plan for Buildings', required: true },
  { key: 'Layout Plan', label: 'Layout Plan', required: true },
  { key: 'Chain Document', label: 'Chain Document', required: true },
  { key: 'Copy of Mortgage Deed', label: 'Copy of Mortgage Deed', required: false },
  { key: 'Copy of Release Deed', label: 'Copy of Release Deed', required: false },
];
...
const kycIncomeDocuments = [
  ...
  { key: 'ITR 2 Years', label: 'ITR 2 Years', required: true },
  { key: 'Photo', label: 'Photo', required: true },
];

const previousLoanDocuments = [
  { key: 'Sanction Letter', label: 'Sanction Letter', required: false },
  { key: 'Account Statement', label: 'Account Statement', required: false },
  { key: 'Co-applicant Contact Details', label: 'Co-applicant Contact Details', required: false },
];
...
function UploadBox({
  ...
  const inputId = `lap-upload-${documentItem.key.replace(/\s+/g, '-').toLowerCase()}`;
...
export default function LAPForm() {
  ...
  const documents = [...propertyDocuments, ...kycIncomeDocuments, ...previousLoanDocuments];
  ...
  const handleOtpChange = (index: number, value: string) => {
    ...
    if (digit && index < 5) {
      document.getElementById(`lap-otp-${index + 1}`)?.focus();
    }
  };
        ...
        <div className="relative z-10 mx-auto max-w-2xl px-4">
          <div className="rounded-[24px] border border-white/95 bg-white/90 p-8 text-center shadow-[0_20px_60px_rgba(37,99,235,0.15)] backdrop-blur-[20px] sm:p-10 [animation:loanFadeUp_0.6s_ease-out_both]">
            ...
            <p className="mb-5 text-3xl text-[#2563EB] [animation:loanFadeUp_0.5s_ease-out_0.35s_both]">
              LAP-{Date.now().toString().slice(-8)}
            </p>
            <p className="mb-8 text-gray-600 [animation:loanFadeUp_0.5s_ease-out_0.45s_both]">
              Our property loan expert will contact you within 2 hours for property valuation.
            </p>
            <a
        ...
        <div className="mx-auto rounded-[24px] border border-white/95 bg-white/90 p-6 shadow-[0_20px_60px_rgba(37,99,235,0.15)] backdrop-blur-[20px] sm:p-8 [animation:loanStepIn_0.3s_ease-in-out_both]">
          ...
          {currentStep === 5 && (
            <div className="[animation:loanStepIn_0.3s_ease-in-out_both]">
              ...
              <p className="mb-6 text-gray-600">Documents shown for Loan Against Property</p>
              ...
              <div className="space-y-5">
                ...
                <div className="rounded-2xl border border-gray-100 bg-white/80 p-5 shadow-sm">
                  ...
                  <div className="grid gap-3 text-gray-700 md:grid-cols-2">
                    ...
                    <p>Co-applicant Name: {formData.coApplicantName}</p>
                    <p>Co-applicant PAN: {formData.coApplicantPan}</p>
                    <p>Co-applicant Aadhaar: {formData.coApplicantAadhaar}</p>
                    <p>Email ID: {formData.emailId}</p>
                    <p>Employment Type: {formData.employmentType}</p>
                ...
                <div className="rounded-2xl border border-gray-100 bg-white/80 p-5 shadow-sm">
                  ...
                  <div className="grid gap-3 text-gray-700 md:grid-cols-2">
                    ...
                    <p>Estimated Property Value: Rs. {formData.estimatedPropertyValue}</p>
                    <p>Loan Amount: Rs. {Number(formData.loanAmount).toLocaleString('en-IN')}</p>
                    <p>Loan Tenure: {formData.loanTenure} months</p>
                    <p>Monthly Income / Turnover: Rs. {formData.monthlyIncome}</p>
