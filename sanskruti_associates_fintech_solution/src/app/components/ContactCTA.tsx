        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-white">
            ...
            <div className="flex items-center gap-2 text-sm text-blue-200">
              ...
              <a href="mailto:sanskruti.sss1108@gmail.com" className="hover:text-white transition-colors">
            ...
            <form className="space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="personal">Personal & Personal & Business Loan</option>
                  <option value="business">Personal & Business Loan</option>
