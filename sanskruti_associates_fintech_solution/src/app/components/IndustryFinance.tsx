    ...
    <div className="relative overflow-hidden bg-[#EFF6FF]">
      ...
      <div className="relative z-10">
        ...
        <section className="relative min-h-screen overflow-hidden text-white bg-[#0F172A]">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-36">
            <div className="max-w-2xl">
              <div className="mb-7 inline-flex items-center gap-3 rounded-full bg-white/10 backdrop-blur-sm px-4 py-2 border border-white/20">
                <div className="w-2 h-2 bg-[#16A34A] rounded-full animate-pulse" />
                <span className="text-sm">All Industry Types Covered</span>
              </div>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl mb-5 leading-tight">
                Industry Finance
              </h1>
              <p className="text-lg sm:text-xl text-blue-100 mb-8 leading-relaxed">
                Complete financial solutions for manufacturing, trading, and service industries —
                fast approval, best rates
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  onClick={goToApplication}
                  className="px-8 py-4 bg-[#16A34A] hover:bg-[#15803D] text-white rounded-lg transition-colors shadow-lg"
                >
                  Apply Now
                </button>
                <button
                  onClick={goToEligibility}
                  className="px-8 py-4 border-2 border-[#60A5FA] text-white hover:bg-white/10 rounded-lg transition-colors"
                >
                  Check Eligibility
                </button>
              </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {highlights.map((item) => (
                ...
                >
                  ...
                  <h3 className="text-xl text-[#1F2937] mb-1">{item.value}</h3>
        ...
        <section className="py-16 lg:py-20 bg-gradient-to-r from-[#2563EB] to-[#1E40AF] text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl lg:text-4xl mb-12">What is Industry Finance?</h2>
        ...
        <section className="py-16 lg:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl lg:text-4xl text-[#1F2937] mb-12">Industries We Finance</h2>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {industriesWeFinance.map((industry) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="text-xl text-[#1F2937] mb-2">{industry.name}</h3>
        ...
        <section className="py-16 lg:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl lg:text-4xl text-[#1F2937] mb-12">
              Types of Industry Finance
            </h2>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {financeTypes.map((type) => (
                <div
                  ...
                  className="bg-white/90 backdrop-blur-md rounded-2xl p-6 border border-white/70 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all"
                >
                  <h3 className="text-xl text-[#1F2937] mb-3">{type.title}</h3>
        ...
        <section className="py-16 lg:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl lg:text-4xl text-[#1F2937] mb-12">Loan Features</h2>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {loanFeatures.map((feature) => (
                ...
                >
                  <h3 className="text-lg text-[#1F2937] mb-2">{feature.title}</h3>
        ...
        <section id="industry-finance-eligibility" className="py-16 lg:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl lg:text-4xl text-[#1F2937] mb-10">Eligibility Criteria</h2>
        ...
        <section className="py-16 lg:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl lg:text-4xl text-[#1F2937] mb-10">Documents Required</h2>
            <DocumentsColumn
              title="Common Documents for All Business Types"
        ...
        <section className="py-16 lg:py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <button
              onClick={goToApplication}
              className="w-full sm:w-auto px-10 py-5 bg-[#16A34A] hover:bg-[#15803D] text-white rounded-xl transition-colors shadow-xl text-lg"
            >
