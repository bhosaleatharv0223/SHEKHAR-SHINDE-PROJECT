...
export function LeadDetails() {
  ...
  const [assignedAgent, setAssignedAgent] = useState('Shekhar Shinde');
  ...
  const bankOffers = [
    { bank: 'HDFC Bank', interest: '8.5%', emi: 'â‚¹32,450', isBest: true },
    { bank: 'ICICI Bank', interest: '8.7%', emi: 'â‚¹32,650', isBest: false },
    { bank: 'SBI', interest: '8.6%', emi: 'â‚¹32,550', isBest: false },
  ];
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-sm text-[#1F2937]">Shekhar Shinde</p>
                </div>
                <div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#1F2937]">â‚¹45,00,000</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-sm text-[#1F2937]">â‚¹1,20,000</p>
                </div>
                <div>
                  <p className="text-xs text-gray-500 mb-1">Existing EMI</p>
                  <p className="text-sm text-[#1F2937]">â‚¹18,000</p>
                </div>
                <div>
